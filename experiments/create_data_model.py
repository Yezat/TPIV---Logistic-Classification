...
def process_data_model_definition(data_model_definition, experiment, logger):
    ...
    try:
        ...
        if data_model_definition.data_model_type == DataModelType.VanillaGaussian:
            data_model = VanillaGaussianDataModel(experiment.d,logger,source_pickle_path="../",delete_existing=data_model_definition.delete_existing, Sigma_w=data_model_definition.Sigma_w, Sigma_delta=data_model_definition.Sigma_delta, Sigma_upsilon=data_model_definition.Sigma_upsilon, name=data_model_definition.name, description=data_model_definition.description)
            ...
            data_model = KFeaturesModel(experiment.d,logger, source_pickle_path="../", delete_existing=data_model_definition.delete_existing, Sigma_w=data_model_definition.Sigma_w, Sigma_delta=data_model_definition.Sigma_delta, Sigma_upsilon=data_model_definition.Sigma_upsilon, name=data_model_definition.name, description=data_model_definition.description, feature_ratios =data_model_definition.feature_ratios, features_x =data_model_definition.features_x, features_theta =data_model_definition.features_theta)
        else:
